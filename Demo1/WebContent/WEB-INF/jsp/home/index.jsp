  	...
  	<body>
		...
		<div class="container">
			...
			<ul class="layui-nav right" lay-filter="">
				<li class="layui-nav-item">
					<a href="javascript:;">${beanUser.username}</a>
					<dl class="layui-nav-child">
						<!-- 二级菜单 -->
						<dd>
				...
				<ul id="nav">
					<li>
						...
						<ul class="sub-menu">
							...
							<li>
								<a _href="RecyclingBin/index.htm">
									<i class="iconfont">&#xe6a7;</i>
									<cite>回收站</cite>
			...
			<div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
				...
				<div class="layui-tab-content">
					<div class="layui-tab-item layui-show">
						<iframe src='home/welcome.htm' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<!-- 底部开始 -->
		<div class="footer">
			<div class="copyright">Copyright ©2019 静畏人心 All Rights Reserved</div>
		</div>
		<!-- 底部结束 -->
		<script>
		</script>
